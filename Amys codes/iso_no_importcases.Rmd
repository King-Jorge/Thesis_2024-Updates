...
### ELIMINATION
out1 <- ode(y = c(S = 5000, I1 = 11, I2 = 0, C1 = 0, iso = 0), parms = NULL, times = seq(0,T,.05), func = SI, events = list(func = NULL, root = TRUE, terminalroot = 1), rootfun=rootfun)
...
values <- c(out.elim$j[nrow(out.elim)], out.elim$C1[nrow(out.elim)])
...
r
# ggsave("~/Desktop/Amy R codes/Isolation_only_no_importations.png", width = 20, height = 15, units = "cm")
